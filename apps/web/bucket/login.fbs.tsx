...
import type { LoginFeedbackState } from '../src/pages/auth/config/login.config';
import { observer } from 'mobx-react-lite';
import AccountSuspended from '@/components/account-suspended';
import { AlertCircle, ChevronRight } from 'lucide-react';
import { useTypedNavigate } from '@/hooks/typed-hooks';

const LoginFeedbackPage = observer(() => {
  const navigate = useTypedNavigate();
  const location = useLocation();
  const state = location.state as LoginFeedbackState | null;
